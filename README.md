...
| `src/ticketflow/models/` | 14 моделей с ограничениями и индексами |
...
Статус: готовы этапы 1–3 — каркас, БД, регистрация, сессии и права доступа.
Следующий этап — каталог и управление мероприятиями, площадками, местами и тарифами.
Создание заказов и покупка билетов пока не реализованы.
