...
бронирования с продажей требует транзакций следующих этапов. Проверка ролей и
владельца реализована в [слое доступа](auth.md). Проверка вместимости относительно
количества мест, суммы заказа относительно позиций,
оплаты перед выпуском билета и допустимости переходов статусов также относится
к сервисной логике этапов 4–8.
